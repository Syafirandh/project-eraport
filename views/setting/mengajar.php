...
function hapus(x) {
    ...
    $('#deleted').on('click', function() {
        var action = '<?=base_url();?>setting/mengajar/delete/' + x;
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <a href="#modal-copy" class="btn btn-sm btn-default btn-flat" data-toggle="modal" onclick="copy()"><i
                    class="fa fa-copy"></i>
                Copy Data</a>
            <a href="<?=base_url('setting/mengajar');?>" class="btn btn-sm btn-primary btn-flat pull-right"
            ...
            <table class="table table-bordered table-striped table-hover datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$row->nama;?></td>
                        <td>
                            <?php foreach(mapel_by_guru($row->idtahun_akademik,$row->semester,$row->idguru) as $m):?>
                            <button class="btn btn-xs btn-default"
                                onclick="hapus(<?=$m->idmengajar;?>)"><?=$m->mapel_nama.' - '.$m->kelas_kd;?></button>
                            <?php endforeach;?>
                        </td>
                        <td><a href="#" class="btn btn-xs btn-default text-red" data-toggle="tooltip"
                                data-placement="top" data-title="Hapus" onclick="hapus(<?=$row->idmengajar;?>)"><i
