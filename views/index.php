                    ...
                    <?php if (__session('access') == 'super_user') : ?>
                        <li class="treeview <?= isset($configuration) ? 'active' : ''; ?>">
                            ...
                            <ul class="treeview-menu">
                                <li <?= isset($profil) ? 'class="active"' : ''; ?>><a href="<?= base_url('profil'); ?>"><i class="fa fa-angle-double-right"></i> Profil Sekolah</a>
                                </li>
                                <li <?= isset($academic_year) ? 'class="active"' : ''; ?>><a href="<?= base_url('configuration/academic_year'); ?>"><i class="fa fa-angle-double-right"></i> Tahun Pelajaran</a>
                                </li>
                        ...
                        <li class="treeview <?= isset($master) ? 'active' : ''; ?>">
                            ...
                            <ul class="treeview-menu">
                                <li <?= isset($rekapTahunAkademik) ? 'class="active"' : ''; ?>><a href="<?= site_url('master/rekapTahunAkademik'); ?>"><i class="fa fa-angle-double-right"></i>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="user_name" name="user_password" placeholder="Ex: admin" min="3" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="user_password">Konfirmasi Password Baru<span class="text-red">*</span></label>
                                        <input type="hidden" name="id">
                                        <input type="hidden" name="url">
                                        <input type="password" class="form-control" id="user_password" name="user_password" placeholder="Ex: admin" min="3" required>
                                    </div>
                                </div>
                            </div>
                        </div>
