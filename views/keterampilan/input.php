...
function saveKKM(x) {
    ...
    $.ajax({
        ...
        url: '<?=base_url();?>keterampilan/save_kkm/' + x,
        dataType: 'json',
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?=base_url('keterampilan');?>">Nilai Keterampilan</a></li>
        <li class="active">Input Nilai Keterampilan</li>
    </ol>
    <?php endif;?>
</section>
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <form class="form-horizontal" action="<?=base_url('keterampilan/save_kkm/').$rowI->idmengajar;?>"
                    method="post">
                    <div class="form-group">
                        <label for="kkm" class="col-xs-2 control-label">KKM</label>
                        <div class="col-xs-4">
                            <input type="hidden" name="current_url"
                                value="<?=base_url('keterampilan/input/').$rowI->kelas_kd.'/'.$rowI->mapel_kd;?>">
        ...
        <div class="box-body" style="overflow-x:scroll;">
            <form action="<?=base_url('keterampilan/save/').$rowI->kelas_kd;?>" method="post">
                <table class="table table-bordered table-hover" style="table-layout:fixed;">
                    ...
                    <tbody>
                        ...
                        <?php foreach (nilai_by_siswa(_active_years()->idtahun_akademik,_active_years()->semester,$rowI->idkelas,$rowI->idmapel,$row->idsiswa) as $keterampilan) :?>
                        <tr>
                            <td><?=$n++.'.';?></td>
                            <td><?=$row->nis;?></td>
                            <td><?=$row->nama;?></td>
                            <td width="100">
                                <input type="hidden" name="idket<?=$row->idsiswa;?>" value="<?=$keterampilan->idket;?>">
                                <input type="number" class="form-control" id="tp1" name="tp1<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_tp1;?>"
                            ...
                            <td>
                                <input type="number" class="form-control" id="tp2" name="tp2<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_tp2;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="tp3" name="tp3<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_tp3;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="tp4" name="tp4<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_tp4;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="tp5" name="tp5<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_tp5;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="tp6" name="tp6<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_tp6;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="tp7" name="tp7<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_tp7;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="rata_tp" name="rata_tp<?=$row->idsiswa;?>"
                                    min="0" max="100" placeholder="0" value="<?=$keterampilan->rata_tp;?>" readonly>
                            </td>
                            <td>
                                <input type="number" class="form-control" id="uh1" name="uh1<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_uh1;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="uh2" name="uh2<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_uh2;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="uh3" name="uh3<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_uh3;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="uh4" name="uh4<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_uh4;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="uh5" name="uh5<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_uh5;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="uh6" name="uh6<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_uh6;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="uh7" name="uh7<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_uh7;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="rata_uh" name="rata_uh<?=$row->idsiswa;?>"
                                    min="0" max="100" placeholder="0" value="<?=$keterampilan->rata_uh;?>" readonly>
                            </td>
                            <td>
                                <input type="number" class="form-control" id="pts" name="pts<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_pts;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                            ...
                            <td>
                                <input type="number" class="form-control" id="uas" name="uas<?=$row->idsiswa;?>" min="0"
                                    max="100" placeholder="0" value="<?=$keterampilan->nilai_uas;?>"
                                    onkeyup="this.value = minmax(this.value,0,100)"
                                    onchange="nilaiAkhir(<?=$row->idsiswa;?>)">
                            </td>
                            <td>
                                <input type="number" class="form-control" id="akhir" name="akhir<?=$row->idsiswa;?>"
                                    min="0" max="100" placeholder="0" value="<?=$keterampilan->nilai_akhir;?>" readonly>
                            </td>
                            <td>
                                <input type="text" class="form-control" id="grade" name="grade<?=$row->idsiswa;?>"
                                    value="<?=$keterampilan->nilai_huruf;?>" readonly>
                            </td>
                            <td>
                                <input type="text" class="form-control" id="deskripsi"
                                    name="deskripsi<?=$row->idsiswa;?>" value="<?=$keterampilan->deskripsi;?>" readonly>
                            </td>
                        </tr>
                        <?php endforeach;?>
                        <?php endforeach;?>
