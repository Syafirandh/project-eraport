...
<section class="content">
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <a href="<?= base_url('master/siswa'); ?>" class="btn btn-sm btn-primary btn-flat pull-right" data-toggle="tooltip" data-placement="top" title="Refresh"><i class="fa fa-refresh"></i></a>
            <a href="<?= base_url('master/siswa/keyAll'); ?>" class="btn btn-sm btn-primary btn-flat pull-right" data-toggle="tooltip" data-toggle="tooltip" data-placement="top" title="Aktifkan akun"><i class="fa fa-key"></i></a>
            <a href="#" class="btn btn-sm btn-primary btn-flat pull-right" data-toggle="tooltip" data-toggle="tooltip" data-placement="top" title="Import" onclick="modal_import()"><i class="fa fa-upload"></i></a>
        </div>
            ...
            <table class="table table-bordered table-striped table-hover datatable">
                ...
                <tbody>
                    ...
                    foreach ($siswa as $row) : ?>
                        <tr>
                            <td><?= $n++ . '.'; ?></td>
                            <td><a href="#modal-add" data-toggle="modal" onclick="submit(<?= $row->idsiswa; ?>)"><i class="fa fa-edit"></i></a>
                            </td>
                            <td><a href="#" data-toggle="tooltip" data-placement="top" data-title="Klik untuk mengubah foto" onclick="change_image(<?= $row->idsiswa; ?>)">
                                    <img src="<?= base_url('uploads/'); ?><?= ($row->foto != '') ? $row->foto : 'default.jpg'; ?>" alt="<?= $row->foto; ?>" style="width:50px;height:50px;border:1px dashed;"></a>
                            </td>
                            <td><?= $row->nis; ?></td>
                            <td><?= $row->nisn; ?></td>
                            <td><?= $row->nama; ?></td>
                            ...
                            <td><a href="#" class="label <?php if ($row->status == 'Aktif') {
                                                                ...
                                                                echo 'bg-gray';
                                                            } ?>" data-toggle="tooltip" data-placement="top" data-title="Klik untuk ubah" onclick="change_sts(<?= $row->idsiswa; ?>)"><?= $row->status; ?></a>
                            </td>
                            <td>
                                <?php if (check_user($row->nis) == 0) : ?>
                                    <a href="<?= base_url('master/siswa/key/') . $row->idsiswa; ?>" class="btn btn-xs btn-default text-aqua" data-toggle="tooltip" data-placement="top" data-title="Aktifkan pengguna"><i class="fa fa-key"></i></a>
                                <?php endif; ?>
                                <a href="#" class="btn btn-xs btn-default text-aqua" data-toggle="tooltip" data-placement="top" data-title="Lihat detail" onclick="view(<?= $row->idsiswa; ?>)"><i class="fa fa-eye"></i></a>
                                <a href="#" class="btn btn-xs btn-default text-red" data-toggle="tooltip" data-placement="top" data-title="Hapus" onclick="hapus(<?= $row->idsiswa; ?>)"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right datepicker" name="tgl_lhr" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="alamat_wali" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <ol>
                        ...
                        <li>Kolom <strong>JENIS KELAMIN</strong> diisi huruf <strong>"L"</strong> jika Laki-laki dan
                            <strong>"P"</strong> jika Perempuan.
                        </li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('master/siswa/status'); ?>" method="post">
                ...
                <div class="modal-footer">
                    <button class="btn btn-sm btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-remove"></i> Batal</button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?= base_url('master/siswa/status'); ?>" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nisn" name="nisn" maxlength="10" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            <label for="nama_lengkap">Nama Lengkap<span class="text-red">*</span></label>
                                            <input type="text" class="form-control" id="nama_lengkap" name="nama" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="tempat_lahir">Tempat Lahir<span class="text-red">*</span></label>
                                            <input type="text" class="form-control" id="tempat_lahir" name="tmp_lhr" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right datepicker" name="tgl_lhr" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="jk" disabled>
                                                <option value="L">Laki-Laki</option>
                                                <option value="P">Perempuan</option>
                                            </select>
                                        </div>
                            ...
                            <div class="tab-pane" id="v_2">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="citacita">Cita-Cita</label>
                                            <input type="text" class="form-control" id="citacita" name="citacita" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Status Dalam Keluarga</label>
                                            <select class="form-control select2" style="width: 100%;" name="sts_anak" disabled>
                                                <option value="Anak Kandung">Anak Kandung</option>
                                                <option value="Anak Tiri">Anak Tiri</option>
                                                <option value="Anak Angkat">Anak Angkat</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="jml_sdr">Jumlah Saudara</label>
                                            <input type="text" class="form-control" id="jml_sdr" name="jml_sdr" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="anak_ke">Anak Ke Berapa</label>
                                            <input type="text" class="form-control" id="anak_ke" name="anak_ke" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="v_3">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nik_ayah">NIK Ayah</label>
                                            <input type="text" class="form-control" id="nik_ayah" name="nik_ayah" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nik_ibu">NIK Ibu</label>
                                            <input type="text" class="form-control" id="nik_ibu" name="nik_ibu" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nama_ayah">Nama Ayah</label>
                                            <input type="text" class="form-control" id="nama_ayah" name="nama_ayah" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nama_ibu">Nama Ibu</label>
                                            <input type="text" class="form-control" id="nama_ibu" name="nama_ibu" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Pendidikan Ayah</label>
                                            <select class="form-control select2" style="width: 100%;" name="pend_ayah" disabled>
                                                <option value="Tidak Sekolah">Tidak Sekolah</option>
                                                <option value="SD/Sederajat">SD/Sederajat</option>
                                                <option value="SMP/Sederajat">SMP/Sederajat</option>
                                                <option value="SMA/Sederajat">SMA/Sederajat</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Pendidikan Ibu</label>
                                            <select class="form-control select2" style="width: 100%;" name="pend_ibu" disabled>
                                                <option value="Tidak Sekolah">Tidak Sekolah</option>
                                                <option value="SD/Sederajat">SD/Sederajat</option>
                                                <option value="SMP/Sederajat">SMP/Sederajat</option>
                                                <option value="SMA/Sederajat">SMA/Sederajat</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="pekr_ayah">Pekerjaan Ayah</label>
                                            <input type="text" class="form-control" id="pekr_ayah" name="pekr_ayah" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="pekr_ibu">Pekerjaan Ibu</label>
                                            <input type="text" class="form-control" id="pekr_ibu" name="pekr_ibu" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Alamat Lengkap Orang Tua</label>
                                            <textarea class="form-control" name="alamat_ortu" rows="5" disabled></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nama_wali">Nama Wali</label>
                                            <input type="text" class="form-control" id="nama_wali" name="nama_wali" placeholder="Ex: Jaki" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="pekr_wali">Pekerjaan Wali</label>
                                            <input type="text" class="form-control" id="pkr_wali" name="pkr_wali" placeholder="Ex: PNS" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Alamat Lengkap Wali</label>
                                            <textarea class="form-control" name="alamat_wali" rows="5" disabled></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-sm btn-default btn-flat pull-right" data-dismiss="modal"><i class="fa fa-remove"></i> Tutup</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="idsiswa">
                        <input type="file" class="form-control" id="foto" name="foto" onchange="preview_foto(event)" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-remove"></i> Batal</button>
