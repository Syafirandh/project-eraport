                ...
                <tbody>
                    ...
                    foreach ($mapel as $row) : ?>
                        <?php #if ($row->tahun_akademik != 0) : ?>
                            <tr>
                                <td><?= $n++ . '.'; ?></td>
                                <td><a href="#modal-add" data-toggle="modal" onclick="submit(<?= $row->idmapel; ?>)"><i class="fa fa-edit"></i></a>
                                </td>
                                <td><?= $row->mapel_kd; ?></td>
                                <td><?= $row->mapel_nama; ?></td>
                                <td><?= getTahunPelajaran($row->tahun_akademik)->tahun_akademik; ?></td>
                                <td><a href="#" class="btn btn-xs btn-default text-red" data-toggle="tooltip" data-placement="top" data-title="Hapus" onclick="hapus(<?= $row->idmapel; ?>)"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php #endif; ?>
                    <?php endforeach; ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mapel_kd" name="mapel_kd" placeholder="Ex: MTK" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="mapel_nama">Mata Pelajaran<span class="text-red">*</span></label>
                                <input type="text" class="form-control" id="mapel_nama" name="mapel_nama" placeholder="Ex: Matematika" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
