...
class Set_kelas extends CI_Controller {
    ...
    */
    public function save_siswa_to_class() {
            ...
            $this->vars['status'] == 'success' ? $this->toastr->success('Data sudah disimpan') : $this->toastr->error('Data tidak tersimpan. Kemungkinan terjadi duplikasi data, pengaturan wali kelas belum diatur, atau server bermasalah, silahkan periksa kembali data Anda.');
