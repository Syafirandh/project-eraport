...
class Nilai_m extends CI_Model {
    ...
    {
        return $this->db->select('x.semester,x4.nis,x4.nisn,x4.tmp_lhr,x4.tgl_lhr,x4.jk,x4.agama,x4.sts_anak,x4.anak_ke,x4.alamat,x4.nama_ayah,x4.nama_ibu,x4.alamat_ortu,x4.pekr_ayah,x4.pekr_ibu,x4.nama_wali,x4.alamat_wali,x4.pekr_wali,x4.nama,x2.kelas_kd,x2.kelas_nama,x1.tahun_akademik,x1.tempat,x1.tanggal')
        ->join('tahun_akademik x1', 'x1.idtahun_akademik = x.idtahun_akademik', 'left')
        ->join('kelas x2', 'x2.idkelas = x.idkelas', 'left')
